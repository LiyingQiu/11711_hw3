...
def Main(args):
    ...
    if args.do_train or args.do_eval or args.split_dataset or args.create_submission_file or args.do_error_analysis:
    ...
    if args.do_train or args.do_eval or args.do_predict or args.do_error_analysis:
...
def main(): 
    ...
    parser.add_argument("--do_error_analysis", action='store_true',
                        help="Set this flag if you are doing error analysis.")
