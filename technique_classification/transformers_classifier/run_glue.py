...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    print(f"Current working directory is {tmp}.")
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        # calculate the accuracy and f1 for each label
...
def transformers_clf(args):
    ...
    # Evaluation
    results = {}
    if args.do_eval or args.do_error_analysis or args.do_predict and args.local_rank in [-1, 0]:
